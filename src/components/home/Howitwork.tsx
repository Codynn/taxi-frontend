      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="relative mb-8 md:mb-10 text-center pt-10">
          <Image
            ...
            width={320}
            height={150}
            className="absolute top-10 left-[48%] -translate-x-1/2 z-0 lg:block hidden"
            aria-hidden
          />
          ...
          <Image
            ...
            width={150}
            height={150}
            className="absolute top-10 left-[48%] -translate-x-1/2 z-0 lg:hidden block"
            aria-hidden
          />

          <h2 className="relative z-10 text-[20px] lg:text-[48px] font-semibold font-sora text-[#000000]">
            {before}
            <span className="px-2 rounded-sm">{highlightedWord}</span>
            {after}
          </h2>

          <p className="relative z-10 mt-4 text-[12px] md:text-[16px] text-[#000000]/65 font-poppins max-w-4xl mx-auto leading-relaxed">
            {description}
          </p>
        </div>
