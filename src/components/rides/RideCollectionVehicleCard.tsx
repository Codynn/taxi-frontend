// components/rides/RideCollectionVehicleCard.tsx
...
export default function RideCollectionVehicleCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#808080]/50 overflow-hidden">
      ...
      <div className="flex flex-col lg:hidden">
        ...
        <div className="flex flex-col gap-3 p-4">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button className="bg-[#FEA800] text-black text-[13px] font-medium font-poppins px-5 py-2.5 rounded-full hover:bg-[#FEA800]/90 transition-colors shrink-0">
              Choose Vehicle
            </button>
          </div>
        </div>
      ...
      {/* ── DESKTOP: row layout matching Figma ── */}
      <div className="hidden lg:flex flex-row p-4">
        ...
        <div className="flex flex-col flex-1 min-w-0 pl-2">
          ...
          {/* Middle: features full-width gray bar */}
          ...
          {/* Bottom: starting from left, button right */}
          <div className="flex items-center justify-between px-6 pt-4 pb-5">
            ...
            <button className="bg-[#FEA800] text-black text-[14px] font-medium font-poppins px-7 py-3 rounded-full hover:bg-[#FEA800]/90 transition-colors shrink-0">
              Choose Vehicle
            </button>
          </div>
        </div>
